...
public class TestEmployee {
	...
	public static void main(String[] args) {
		var jack = new Employee.Builder(
				TcKimlikNo.valueOf("10317704294")
			).iban("BE03321522542584")
			 .salary(35_000)
			 .departments("SALES", "FINANCE")
			 .style(JobStyle.FULL_TIME)
			 ...
			 .build();
		 // promote -> Ubiq. Lang. 
		 jack.promote(Money.valueOf(50_000),Department.IT);
		 // jack.getDepartments().add(Department.HR);
         System.out.println(jack);
         jack.updateSalary(Rate.of(0.5));
         System.out.println(jack);
	}
